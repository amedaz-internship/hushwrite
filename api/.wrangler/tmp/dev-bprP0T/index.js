...
async function derivePasswordKey(password, salt) {
  ...
  return crypto.subtle.deriveKey(
    ...
    true,
    // extractable so we can export the raw bytes as the hash
    ["encrypt"]
  );
}
...
function base64urlToBuffer(base64url2) {
...
async function upsertNote(db, userId, note) {
  await db.prepare(
    ...
    note.created_at || (/* @__PURE__ */ new Date()).toISOString(),
...
// .wrangler/tmp/bundle-5l0WWC/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-5l0WWC/middleware-loader.entry.ts
